 ...
 * <p> 定义了抽象方法 {@link #createBean(String, org.springframework.beans.factory.config.BeanDefinition)}, 具备了根据 beanDefinition 创建 bean 的能力，由 {@link AbstractAutowireCapableBeanFactory} 子类实现
 *
 * @author zhengxin
